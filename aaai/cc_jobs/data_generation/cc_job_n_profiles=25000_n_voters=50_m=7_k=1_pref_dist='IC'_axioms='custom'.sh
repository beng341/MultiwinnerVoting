...
python -m network_ops.generate_data "n_profiles=25000" "prefs_per_profile=50" "m=7" "num_winners=1" "learned_pref_model='IC'" "pref_model='IC'" "axioms=['reduced']" "out_folder='aaai/results/data'" "varied_voters=False" "voters_std_dev=0" "rwd_folder=''" "train=True" "test=True"
