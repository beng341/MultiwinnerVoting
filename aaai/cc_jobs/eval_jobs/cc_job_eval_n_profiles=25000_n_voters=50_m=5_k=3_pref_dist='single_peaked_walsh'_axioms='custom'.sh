...
python -m network_ops.evaluate_networks "n_profiles=25000" "n_voters=50" "varied_voters=False" "voters_std_dev=0" "m=5" "num_winners=3" "data_path='aaai/results/data'" "network_path='aaai/results/trained_networks/trained_networks'" "out_folder='aaai/results/results'" "rwd_folder=''" "pref_dist='single_peaked_walsh'" "axioms=['reduced']"
