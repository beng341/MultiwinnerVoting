...
python -m network_ops.train_networks "n_profiles=25000" "n_voters=50" "m=5" "num_winners=1" "data_path='aaai/results/data'" "out_folder='aaai/results/trained_networks'" "pref_dist='IAC'" "varied_voters=False" "voters_std_dev=0"
