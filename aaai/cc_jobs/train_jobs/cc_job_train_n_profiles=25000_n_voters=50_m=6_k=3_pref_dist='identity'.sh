...
python -m network_ops.train_networks "n_profiles=25000" "n_voters=50" "m=6" "num_winners=3" "data_path='aaai/results/data'" "out_folder='aaai/results/trained_networks'" "pref_dist='identity'" "axioms=['reduced']" "varied_voters=False" "voters_std_dev=0"
