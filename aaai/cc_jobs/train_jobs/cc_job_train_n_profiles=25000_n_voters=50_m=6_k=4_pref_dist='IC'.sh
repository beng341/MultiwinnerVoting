...
python -m network_ops.train_networks "n_profiles=25000" "n_voters=50" "m=6" "num_winners=4" "data_path='aaai/results/data'" "out_folder='aaai/results/trained_networks'" "pref_dist='IC'" "axioms=['reduced']" "varied_voters=False" "voters_std_dev=0"
