...
python -m network_ops.generate_data "n_profiles=25000" "prefs_per_profile=50" "m=5" "num_winners=1" "learned_pref_model='IC'" "pref_model='IC'" "axioms='all'" "out_folder='/scratch/b8armstr/data'"
