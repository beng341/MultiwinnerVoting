...
python -m network_ops.generate_data "n_profiles=25000" "prefs_per_profile=50" "m=5" "num_winners=1" "learned_pref_model='euclidean__args__dimensions=3_-_space=gaussian_ball'" "pref_model='euclidean__args__dimensions=3_-_space=gaussian_ball'" "axioms='all'" "out_folder='/scratch/b8armstr/data-ijcai'"
