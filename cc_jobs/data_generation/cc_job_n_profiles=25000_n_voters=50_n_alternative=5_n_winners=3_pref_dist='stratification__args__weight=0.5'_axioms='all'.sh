...
python -m network_ops.generate_data "n_profiles=25000" "prefs_per_profile=50" "m=5" "num_winners=3" "learned_pref_model='stratification__args__weight=0.5'" "axioms='all'" "out_folder='data'"
