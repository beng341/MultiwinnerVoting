...
python -m network_ops.generate_data "n_profiles=25000" "prefs_per_profile=50" "m=6" "num_winners=3" "learned_pref_model='euclidean__args__dimensions=10_-_space=gaussian_cube'" "pref_model='euclidean__args__dimensions=10_-_space=gaussian_cube'" "axioms='all'" "out_folder='/scratch/b8armstr/data'"
