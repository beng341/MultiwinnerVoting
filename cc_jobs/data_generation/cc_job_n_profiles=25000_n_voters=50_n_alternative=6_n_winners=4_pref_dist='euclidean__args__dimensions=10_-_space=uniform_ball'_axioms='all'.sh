...
python -m network_ops.generate_data "n_profiles=25000" "prefs_per_profile=50" "m=6" "num_winners=4" "learned_pref_model='euclidean__args__dimensions=10_-_space=uniform_ball'" "pref_model='euclidean__args__dimensions=10_-_space=uniform_ball'" "axioms='all'" "out_folder='$HOME/scratch/data'"
