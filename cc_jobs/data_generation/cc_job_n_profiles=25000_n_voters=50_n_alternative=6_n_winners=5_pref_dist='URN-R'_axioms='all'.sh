...
python -m network_ops.generate_data "n_profiles=25000" "prefs_per_profile=50" "m=6" "num_winners=5" "learned_pref_model='URN-R'" "pref_model='URN-R'" "axioms='all'" "out_folder='/scratch/b8armstr/data'"
