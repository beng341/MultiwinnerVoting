...
python -m network_ops.generate_data "n_profiles=25000" "prefs_per_profile=50" "m=7" "num_winners=2" "learned_pref_model='single_peaked_walsh'" "pref_model='single_peaked_walsh'" "axioms='all'" "out_folder='/scratch/b8armstr/data'"
