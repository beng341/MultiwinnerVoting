...
python -m network_ops.generate_data "n_profiles=25000" "prefs_per_profile=50" "m=7" "num_winners=3" "learned_pref_model='euclidean__args__dimensions=3_-_space=uniform_ball'" "axioms='all'" "out_folder='data'"
