...
python -m network_ops.generate_data "n_profiles=50000" "prefs_per_profile=50" "m=5" "num_winners=3" "learned_pref_model='MALLOWS-RELPHI-R'" "axioms='all'" "out_folder='data'"
