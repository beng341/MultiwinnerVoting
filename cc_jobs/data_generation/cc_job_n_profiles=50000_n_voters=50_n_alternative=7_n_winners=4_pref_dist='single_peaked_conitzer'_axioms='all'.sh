...
python -m network_ops.generate_data "n_profiles=50000" "prefs_per_profile=50" "m=7" "num_winners=4" "learned_pref_model='single_peaked_conitzer'" "axioms='all'" "out_folder='data'"
