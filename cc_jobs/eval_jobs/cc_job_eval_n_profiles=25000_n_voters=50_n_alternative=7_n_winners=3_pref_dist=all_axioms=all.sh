...
python -m network_ops.evaluate_networks "m=7" "num_winners=3" "data_path='/scratch/b8armstr/data-ijcai'" "out_folder='evaluation_results-ijcai'" "network_path='/scratch/b8armstr/ijcai/trained_networks'"
