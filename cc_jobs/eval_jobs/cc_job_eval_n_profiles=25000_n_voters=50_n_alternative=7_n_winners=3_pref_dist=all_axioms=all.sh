...
python -m network_ops.evaluate_networks "m=7" "num_winners=3" "data_path='/scratch/b8armstr/data'" "out_folder='evaluation_results_thesis_with_min_and_max'" "network_path='/scratch/b8armstr/thesis_results/trained_networks'"
