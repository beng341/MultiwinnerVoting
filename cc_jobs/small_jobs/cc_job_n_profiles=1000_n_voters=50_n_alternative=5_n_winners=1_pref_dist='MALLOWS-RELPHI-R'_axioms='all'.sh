...
python -m network_ops.generate_data "n_profiles=1000" "prefs_per_profile=50" "m=5" "num_winners=1" "learned_pref_model='MALLOWS-RELPHI-R'" "axioms='all'" "out_folder='data'"
