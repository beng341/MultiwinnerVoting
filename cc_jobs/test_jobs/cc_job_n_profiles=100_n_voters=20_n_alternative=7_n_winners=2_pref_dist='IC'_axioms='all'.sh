...
python -m network_ops.generate_data "n_profiles=100" "prefs_per_profile=20" "m=7" "num_winners=2" "learned_pref_model='IC'" "axioms='all'" "out_folder='data/test_job_results'"
