...
python -m network_ops.train_networks "m=6" "num_winners=1" "data_path='/scratch/b8armstr/data'"
python -m network_ops.evaluate_networks "m=6" "num_winners=1" "data_path='/scratch/b8armstr/data'" "out_folder='evaluation_results_fixed_fm'"
