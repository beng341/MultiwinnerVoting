...
python -m network_ops.train_networks "m=5" "num_winners=3" "pref_dist='euclidean__args__dimensions=10_-_space=gaussian_cube'" "data_path='/scratch/b8armstr/data'" "out_folder='/scratch/b8armstr/thesis_results'"
python -m network_ops.evaluate_networks "m=5" "num_winners=3" "data_path='/scratch/b8armstr/data'" "out_folder='evaluation_results_thesis'" "network_path='/scratch/b8armstr/thesis_results/trained_networks'"
