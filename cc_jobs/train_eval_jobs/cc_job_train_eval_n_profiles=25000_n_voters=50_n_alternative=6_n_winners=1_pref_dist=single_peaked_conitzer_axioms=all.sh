...
python -m network_ops.train_networks "m=6" "num_winners=1" "pref_dist='single_peaked_conitzer'" "data_path='/scratch/b8armstr/data'" "out_folder='/scratch/b8armstr/thesis_results'"
