...
python -m network_ops.train_networks "m=6" "num_winners=4" "pref_dist='euclidean__args__dimensions=10_-_space=uniform_ball'" "data_path='/scratch/b8armstr/data'" "out_folder='/scratch/b8armstr'"
