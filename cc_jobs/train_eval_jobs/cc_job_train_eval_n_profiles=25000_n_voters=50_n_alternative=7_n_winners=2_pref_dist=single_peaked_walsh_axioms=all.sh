...
python -m network_ops.train_networks "m=7" "num_winners=2" "pref_dist='single_peaked_walsh'" "data_path='/scratch/b8armstr/data'" "out_folder='/scratch/b8armstr/thesis_results'"
