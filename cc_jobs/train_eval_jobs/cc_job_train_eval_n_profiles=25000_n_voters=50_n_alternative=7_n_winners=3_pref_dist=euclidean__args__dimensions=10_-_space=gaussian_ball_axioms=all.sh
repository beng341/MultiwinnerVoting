...
python -m network_ops.train_networks "m=7" "num_winners=3" "pref_dist='euclidean__args__dimensions=10_-_space=gaussian_ball'" "data_path='/scratch/b8armstr/data'" "out_folder='/scratch/b8armstr'"
python -m network_ops.evaluate_networks "m=7" "num_winners=3" "data_path='/scratch/b8armstr/data'" "out_folder='evaluation_results_fixed_fm'" "network_path='/scratch/b8armstr/trained_networks'"
