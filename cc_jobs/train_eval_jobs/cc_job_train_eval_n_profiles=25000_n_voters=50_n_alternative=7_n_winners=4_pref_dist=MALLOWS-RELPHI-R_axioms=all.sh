...
python -m network_ops.train_networks "m=7" "num_winners=4" "pref_dist='MALLOWS-RELPHI-R'" "data_path='/scratch/b8armstr/data'" "out_folder='/scratch/b8armstr/thesis_results'"
