...
python -m network_ops.train_networks "m=7" "num_winners=6" "pref_dist='stratification__args__weight=0.5'" "data_path='/scratch/b8armstr/data'" "out_folder='/scratch/b8armstr/thesis_results'"
