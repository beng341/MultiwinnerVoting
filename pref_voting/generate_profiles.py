...
from prefsampling.ordinal import identity, impartial, impartial_anonymous, urn, plackett_luce, didi, stratification, single_peaked_conitzer, single_peaked_walsh, single_peaked_circle, single_crossing, euclidean, mallows
...
def get_rankings(num_candidates, num_voters, **kwargs): 
    ...
    if probmodel == "identity":
        rankings = identity(num_voters,
                            num_candidates,
                            seed=seed)
    elif probmodel == "IC" or probmodel == 'impartial':
